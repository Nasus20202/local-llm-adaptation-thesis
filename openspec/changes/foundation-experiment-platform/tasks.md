...
- [x] 2.1 Implement strict schema-version-1 models for experiment, reference, model, hardware, dataset, and evaluation metadata; test required fields, strict types, identifiers, hashes, exact full-commit model revisions, stable dataset/evaluation labels with the three reserved moving labels, unknown fields, and unsupported versions.
