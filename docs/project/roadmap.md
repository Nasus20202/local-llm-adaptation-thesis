...
4. [Issue #35](https://github.com/Nasus20202/local-llm-adaptation-thesis/issues/35) is approved and its focused authorization package was independently reviewed and squash-merged in [PR #38](https://github.com/Nasus20202/local-llm-adaptation-thesis/pull/38). The exact Kubernetes `v1.36.4` [source/release rights manifest](../research/development-pilot-source-rights-manifest.md) is proposed for human review and remains unfrozen. No family may be authored before approval and merge; model execution, final-test work, real `kind`, and live W1 remain separately closed.
